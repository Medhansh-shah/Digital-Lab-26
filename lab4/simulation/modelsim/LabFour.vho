...
SIGNAL \dut_instance|BCD1|FA1|HA2|S~0\ : std_logic;
SIGNAL \dut_instance|BCD1|FA1|OR1|Y~0\ : std_logic;
SIGNAL \dut_instance|BCD1|FA2|OR1|Y~0\ : std_logic;
SIGNAL \datau[2]~0\ : std_logic;
SIGNAL \dut_instance|BCD1|OR2|Y~0\ : std_logic;
...
SIGNAL \datau[2]~5_combout\ : std_logic;
...
SIGNAL \dut_instance|BCD1|FA7|HA2|C\ : std_logic;
...
-- Equation(s):
-- \dut_instance|BCD1|FA1|OR1|Y~0\ = (dut_input(1) & ((dut_input(5)) # ((dut_input[4] & dut_input(0))))) # (!dut_input(1) & (dut_input(5) & (dut_input[4] & dut_input(0))))
-- dut_input(4) = DFFEAS(\dut_instance|BCD1|FA1|OR1|Y~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|BCD1|FA1|OR1|Y~0\,
	regout => dut_input(4));

-- Location: LC_X15_Y8_N7
\dut_input[0]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|BCD1|FA1|HA2|S~0\ = dut_input(1) $ (dut_input(5) $ (((dut_input[0] & dut_input(4)))))
-- dut_input(0) = DFFEAS(\dut_instance|BCD1|FA1|HA2|S~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|BCD1|FA1|HA2|S~0\,
	regout => dut_input(0));

-- Location: LC_X15_Y9_N9
\dut_input[2]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|BCD1|FA2|OR1|Y~0\ = ((dut_input(6) & ((dut_input[2]) # (\dut_instance|BCD1|FA1|OR1|Y~0\))) # (!dut_input(6) & (dut_input[2] & \dut_instance|BCD1|FA1|OR1|Y~0\)))
-- dut_input(2) = DFFEAS(\dut_instance|BCD1|FA2|OR1|Y~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	datab => dut_input(6),
	datac => data(2),
	datad => \dut_instance|BCD1|FA1|OR1|Y~0\,
	aclr => GND,
	sload => VCC,
	ena => \shift_reg~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|BCD1|FA2|OR1|Y~0\,
	regout => dut_input(2));

-- Location: LC_X15_Y9_N0
\dut_input[6]\ : maxv_lcell
-- Equation(s):
-- \datau[2]~0\ = (!\dut_instance|BCD1|FA1|HA2|S~0\ & (\dut_instance|BCD1|FA1|OR1|Y~0\ $ (dut_input[6] $ (!dut_input(2)))))
-- dut_input(6) = DFFEAS(\datau[2]~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \shift_reg~0_combout\, 
-- data(6), , , VCC)
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|BCD1|FA1|HA2|S~0\,
	datab => \dut_instance|BCD1|FA1|OR1|Y~0\,
	datac => data(6),
	datad => dut_input(2),
	aclr => GND,
	sload => VCC,
...
-- Equation(s):
-- \dut_instance|BCD1|OR2|Y~0\ = (dut_input(7) & ((\dut_instance|BCD1|FA2|OR1|Y~0\) # ((dut_input[3]) # (!\datau[2]~0\)))) # (!dut_input(7) & ((\dut_instance|BCD1|FA2|OR1|Y~0\ & ((dut_input[3]) # (!\datau[2]~0\))) # (!\dut_instance|BCD1|FA2|OR1|Y~0\ & 
-- (dut_input[3] & !\datau[2]~0\))))
-- dut_input(3) = DFFEAS(\dut_instance|BCD1|OR2|Y~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => dut_input(7),
	datab => \dut_instance|BCD1|FA2|OR1|Y~0\,
	datac => data(3),
	datad => \datau[2]~0\,
	aclr => GND,
	sload => VCC,
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|BCD1|OR2|Y~0\,
	regout => dut_input(3));

-- Location: LC_X15_Y9_N6
\dut_input[7]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|BCD1|FA7|HA2|C\ = (!\datau[2]~0\ & (\dut_instance|BCD1|FA2|OR1|Y~0\ $ (dut_input(3) $ (dut_input[7]))))
-- dut_input(7) = DFFEAS(\dut_instance|BCD1|FA7|HA2|C\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|BCD1|FA2|OR1|Y~0\,
	datab => dut_input(3),
	datac => data(7),
	datad => \datau[2]~0\,
	aclr => GND,
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|BCD1|FA7|HA2|C\,
	regout => dut_input(7));

-- Location: LC_X15_Y9_N7
\datau[3]~7\ : maxv_lcell
-- Equation(s):
-- \datau[3]~7_combout\ = (dut_input(7) & (dut_input(3) $ (\dut_instance|BCD1|FA2|OR1|Y~0\ $ (\datau[2]~0\)))) # (!dut_input(7) & ((dut_input(3) & (\dut_instance|BCD1|FA2|OR1|Y~0\ $ (\datau[2]~0\))) # (!dut_input(3) & (\dut_instance|BCD1|FA2|OR1|Y~0\ & 
-- \datau[2]~0\))))
...
PORT MAP (
	dataa => dut_input(7),
	datab => dut_input(3),
	datac => \dut_instance|BCD1|FA2|OR1|Y~0\,
	datad => \datau[2]~0\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\datau[4]\ : maxv_lcell
-- Equation(s):
-- datau(4) = DFFEAS((\shift_reg~2_combout\ & (((\dut_instance|BCD1|FA7|HA2|C\)))) # (!\shift_reg~2_combout\ & (!\shift_reg~3_combout\ & (datau(4)))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
PORT MAP (
	...
	datad => \dut_instance|BCD1|FA7|HA2|C\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => datau(4));
...
\datau[3]\ : maxv_lcell
-- Equation(s):
-- datau(3) = DFFEAS(((\shift_reg~2_combout\ & (\datau[3]~7_combout\)) # (!\shift_reg~2_combout\ & ((datau(4))))), 
...
\datau[2]~4\ : maxv_lcell
-- Equation(s):
-- \datau[2]~4_combout\ = (\shift_reg~2_combout\ & (\dut_instance|BCD1|OR2|Y~0\ & (\datau[2]~0\))) # (!\shift_reg~2_combout\ & (((datau(3)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|BCD1|OR2|Y~0\,
	datab => \datau[2]~0\,
	datac => datau(3),
...
\datau[2]~5\ : maxv_lcell
-- Equation(s):
-- \datau[2]~5_combout\ = (\shift_reg~2_combout\ & (\dut_instance|BCD1|FA1|OR1|Y~0\ $ (dut_input(6) $ (dut_input(2)))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \datau[2]~5_combout\);

-- Location: LC_X16_Y8_N2
\datau[2]\ : maxv_lcell
-- Equation(s):
-- datau(2) = DFFEAS((\datau[2]~4_combout\) # ((\datau[2]~5_combout\ & ((\dut_instance|BCD1|FA1|HA2|S~0\) # (!\dut_instance|BCD1|OR2|Y~0\)))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[0]~2_combout\, , , , )
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|BCD1|OR2|Y~0\,
	datab => \dut_instance|BCD1|FA1|HA2|S~0\,
	datac => \datau[2]~4_combout\,
	datad => \datau[2]~5_combout\,
	aclr => GND,
	ena => \datau[0]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\datau[1]\ : maxv_lcell
-- Equation(s):
-- datau(1) = DFFEAS((\shift_reg~2_combout\ & (\dut_instance|BCD1|OR2|Y~0\ $ ((\dut_instance|BCD1|FA1|HA2|S~0\)))) # (!\shift_reg~2_combout\ & (((datau(2))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[0]~2_combout\, , , , )
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|BCD1|FA7|HA2|C\,
	oe => VCC,
